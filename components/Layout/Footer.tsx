          ...
          <div className="md:w-[38.6%] lg:w-[43%] flex flex-col gap-3 md:gap-8">
            ...
            <p>
              <span className={listStyle}>
                ...
                with international admissions. We provide professional support
                and advice to those who want to study abroad.
              </span>{" "}
              <Link
                href="about-us"
                className="underline text-white text-xs lg:text-sm"
              >
                see more
              </Link>{" "}
            </p>
